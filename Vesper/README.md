...
I am aware of how long the script is. It gets the job done! However, I would do it differently now. I would make scriptable objects that store the attributes of each size and assign them depending on the chosen size.  
